...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  if (!args || !args[0]) throw `*Estas usando mal el comando*
*Ejemplo:* *_${usedPrefix}${command}_* unptoadrih15 
`.trim()
...
handler.command = /^(igstalk|igs|stalk|igver|verig|igusuario|usuarioig|verinstagram|instagramver)$/i
handler.limit = false
