...
let handler = async (m, { conn }) => {
  ...
  await m.reply('_Probando la velocidad..._')
...
💬 Estado :
- *${groupsIn.length}* chat de grupos
- *${groupsIn.length}* Grupos activos
- *${groupsIn.length - groupsIn.length}* Grupos eliminados
...
_Uso de CPU Core(s) (${cpus.length} Core CPU)_
