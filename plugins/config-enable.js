...
{title: "🤖 | 𝚂𝙸𝙼𝙸", description: "𝙴𝙻 𝙱𝙾𝚃 𝙷𝙰𝙱𝙻𝙰𝚁𝙰 𝙿𝙾𝚁 𝚂𝙸 𝚂𝙾𝙻𝙾 𝚁𝙴𝚂𝙿𝙾𝙽𝙳𝙸𝙴𝙽𝙳𝙾 𝙰 𝚃𝙾𝙳𝙾𝚂 𝙻𝙾𝚂 𝙼𝙴𝙽𝚂𝙰𝙹𝙴𝚂 𝙲𝙾𝙼𝙾 𝚂𝙸 𝙵𝚄𝙴𝚁𝙰 𝚂𝙸𝙼𝚂𝙸𝙼𝙸", rowId: `${usedPrefix + command} pconly`},
...
const listMessage = {
text: ' ',
footer: `*(̅_̅_̅(̲̲̲̲̲̅̅̅̅̅̅(̅_̅_̲̅✨𝐇𝐎𝐋𝐀, ${name} _̅_̅_̅()ڪ*
...
⚜️ PARA: ${isAll ? 'ESTE BOT' : isUser ? '' : 'ESTE CHAT'}`, author, null, [[`${isEnable ? '❗ DESACTIVAR ❗' : '✨ ACTIVAR ✨'}`, `${isEnable ? `.off ${type}` : `.on ${type}`}`], ['🤖', 'bot']],m)}
