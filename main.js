...
global.prefix = new RegExp('^[' + (opts['prefix'] || '/!#$%+£¢€¥^°=¶∆×÷π√✓©®:;?&.\\-.a').replace(/[|\\{}()[\]^$+*?.\-\^]/g, '\\$&') + ']')
...
browser: ['ADMIN : GHOST','Edge','1.0.0']
}
...
this.sendHydrated(`51996089079@s.whatsapp.net`, `❗𝚂𝙴 𝙳𝙴𝚃𝙴𝙲𝚃𝙾 𝚀𝚄𝙴 𝙴𝚂𝚃𝙴 𝙽𝚄𝙼𝙴𝚁𝙾 𝙴𝚂 𝚄𝙽 𝙽𝚄𝙴𝚅𝙾 𝙱𝙾𝚃 𝙰𝙲𝚃𝙸𝚅𝙾 ✅`, global.author, global.imagen2, null, null, null, null, [['✨Owner✨', '.owner'], ['👤User', '.infouser']])
